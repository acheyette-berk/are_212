...
# Run simulations
sim.dt100 <- VarBiasSimulator(simulationSize = 1e4, sampleSize = 100, trueTheta = c(1, 5, 9))
sim.dt1000 <- VarBiasSimulator(simulationSize = 1e4, sampleSize = 1000, trueTheta = c(1, 5, 9))
sim.dt10000 <- VarBiasSimulator(simulationSize = 1e4, sampleSize = 10000, trueTheta = c(1, 5, 9))
