...
setwd("C:/Users/elean/Documents/ARE212/ProblemSet2")

#### 1 ####

# Load data
my_data <- read_dta("pset2_2024.dta")
head(my_data)

# Create new variables
my_data <- mutate(my_data, logprice=log(price), logqu=log(qu), carspc=qu/pop)
...
(histqu <- histqu + xlab("Quantity") + ylab("Number of Observations") + ggtitle("Histogram of Quantity"))
...
# TODO how explain findings?? ####
# why Rsquared so different???

#### 9 ####

# regression of quantity on price
# get degrees of freedom, coefficient, and sample size
print("sample size, n = 57")
print("number of explanatory variables, k = 1")
print("degrees of freedom, n - k = 56")
print("estimate of coefficient, b = 591.1")
...
plot(x = y1, # True values on x-axis
     ...
     main = "Fitted vs. true values for regression of quantity on price (no constant)")
...
plot(x = y1, # True values on x-axis
     ...
     xlab = "True Values",
     ylab = "Residuals",
     main = "Residuals vs. true values for regression of quantity on price (no constant)")

print("There appears to be a positive linear relationship between the quantity and the residual.")
...
plot(x = y10, # True values on x-axis
     ...
     xlab = "True Values",
     ylab = "Model Fitted Values",
     main = "Fitted vs. true values for regression of quantity on price with constant")
...
plot(x = y10, # True values on x-axis
     ...
     xlab = "True Values",
     ylab = "Residuals",
     main = "Residuals vs. true values for regression of quantity on price with constant")

# What do you see in terms of fit and whether constant variance assumption for residuals is valid?
# Has the fit improved or not relative to the question 8 analysis?
# TODO constant variance assumption valid??? ####
print("Rsquared has improved; was negative, now is between 0 and 1")
print("However, residuals still have a positive linear relationship with quantity")
...
# Compare to analysis in question 10.
# Why do you get this? Explain the theorem behind this briefly.
print("We get the same coefficient for qu in 10 and dmeanqu in 11.")
print("We also get the same Rsquared for 10 and 11.")
# TODO explain why equivalent (theorem??) ####
...
plot(x = y12, # True values on x-axis
     ...
     xlab = "True Values",
     ylab = "Model Fitted Values",
     main = "Fitted vs. true values for multivariate linear regression of quantity")

# TODO what do you see in terms of fit? ####
...
plot(x = my_data$fuel, # fuel efficiency on x-axis
     ...
     ylab = "Residuals",
     main = "Residuals vs. fuel efficiency from multivariate linear regression of quantity")
...
print("b13 is equal to the coefficient of fuel efficiency in the regression of qu on on a constant, price, luxury indicator, weight, and fuel efficiency.")
print("It is equal because regressing qu and fuel on the other factors and then regressing the residuals is equivalent to finding the coefficient in a multivariate linear regression.")
# TODO theoretical reason why coefficients equal?? ####
...
plot(x = my_data$logprice, # logprice
     ...
     main = "Log of Quantity (Predicted) vs. Log of Price from Regression in Logs")

# Call this the Regression in logs.
# Is the estimated car demand elastic with respect to price?
print("Yes, demand is elastic with respect to price because the absolute value of the coefficient is greater than 1.")
print("A 100% increase in price leads to a >400% decrease in demand.")
...
print("As the sample size increases, beta0 approaches 0 and beta1 approaches 1.")
